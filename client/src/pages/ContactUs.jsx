...
function ContactUs() {
  ...
  return (
    ...
    >
       {/* H2 Page Title */}
      <Text as="h2" id="pageTitle" color="#ffffff" fontWeight="600" fontSize="3rem" mb={10}>
        Contact Us
      </Text>
      ...
      >
        ...
        <Box role="heading" aria-level="3" textAlign={["center", "right"]} pr={[0, 4]} >
          <Text fontWeight="bold" fontSize="lg" textAlign="left" mb={2} id="addressTitle">
            Address:
          </Text>
        </Box>
