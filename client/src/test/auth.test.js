...
// Replace the global localStorage with the mock version for testing
...
describe('Error Handling Tests', () => {
  ...
  test('should handle 401 response by clearing localStorage', () => {
  ...
  // Test: Verify that 401 errors trigger redirect to login page
